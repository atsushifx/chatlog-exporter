...
import type { LogCapture, LogSilencer } from '../../../../../skills/_scripts/__tests__/helpers/e2e-setup.ts';
import { captureLog, makeTempDirs, removeTempDirs, silenceLog } from '../../../../../skills/_scripts/__tests__/helpers/e2e-setup.ts';
